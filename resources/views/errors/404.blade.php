...
@push('styles')
   <style>
        ...
        box-shadow:
            inset 0px 16px #03a824,
            inset 0px 16px 1px 1px #03a81c;
        -moz-box-shadow:
            inset 0px 16px #03a827,
            inset 0px 16px 1px 1px #03a824;
        }
        .antenna::after {
        content: "";
        position: absolute;
        ...
        box-shadow: inset 0.2em 0.2em var(--accent);
        }
        .tv::after {
        content: "";
        position: absolute;
        ...
        justify-content: center;
        border-radius: 15px;
        box-shadow: 3.5px 3.5px 0px #35e638;
        }
        .screen_out {
        width: auto;
        height: auto;
        ...
        */
        ...
        flex-direction: column;
        row-gap: 0.75em;
        box-shadow: 3px 3px 0px #35e699;
        }
        .b1 {
        width: 1.65em;
        height: 1.65em;
        border-radius: 50%;
        background-color: #357f34;
        border: 2px solid black;
        box-shadow:
            inset 2px 2px 1px #78b477,
            -2px 0px #215128,
        ...
        border: 2px solid black;
        box-shadow: inset 1.25px 1.25px 1px #77b47e;
        }
        .speakers .g {
        width: auto;
        height: 2px;
...
@endpush
@section('content')
<section class="min-vh-100 bg-body py-5 d-flex align-items-center justify-content-center">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6 text-center text-lg-start">
                <div class="error-visual">
                    <h1 class="fw-800 text-accent opacity-25" style="font-size: 14rem;line-height: 1;">404</h1>
                </div>

                <h2 class="display-4 fw-bold mb-3">System <span class="text-accent fraunces section-accent fw-normal">Disconnected.</span></h2>
                <p class="text-secondary fs-5 mb-5">
                    The path you are looking for has been moved, renamed, or is currently out of sync with our data architecture.
                </p>

                <div class="d-flex flex-column flex-md-row justify-content-center justify-content-lg-start gap-3">
                    <a href="{{ url('/') }}" class="btn btn-accent rounded-pill px-5 py-3 fw-bold">
                        <i class="fa fa-arrow-left"></i> Return to Home
                    </a>
                    <a href="{{ url('/contact') }}" class="btn btn-outline-secondary rounded-pill px-5 py-3 fw-bold">
                        <i class="fa fa-binoculars"></i> Report an Issue
                    </a>
                </div>
            </div>
        </div>
