                    ...
                    <div class="dropdown-menu mega-menu-container bg-body">
                        <div class="container-fluid p-0">
                            <div class="row g-0 align-items-stretch">
                                ...
                                <div class="col-xl-3 border-xl-end p-2 p-xxl-5 d-none d-xl-flex flex-column justify-content-between bg-light-subtle">
                                    <div>
                                ...
                                <div class="col-lg-8 col-xl-6 border-lg-end p-2 p-xxl-5">
                                    ...
                                    <div class="row g-xxl-2">
                                        ...
                                        @foreach($modules as $module)
                                            <div class="col-12 col-lg-6 col-xl-6">
                                                <a class="dropdown-item d-flex align-items-center py-xxl-2  px-2 rounded-3" href="{{ url('/modules/'.$module['slug']) }}">
                                                    <div class="icon-box-sm border rounded-2 me-2 d-none d-xl-flex align-items-center justify-content-center bg-body" style="width: 35px; height: 35px; min-width: 35px;">
                                ...
                                <div class="col-lg-4 col-xl-3 p-2 p-xxl-5">
                                    <h6 class="small text-uppercase fw-bold mb-4 opacity-50">Industries</h6>
                                    <div class="d-flex flex-column gap-xxl-1">
                                        @php
                                            $industries = [
                                        ...
                                        @foreach($industries as $industry)
                                            <a class="dropdown-item d-flex align-items-center py-xxl-2 px-2 rounded-3" href="{{ url('/industries/'.$industry['slug']) }}">
                                                <div class="icon-box-sm border rounded-2 me-2 d-none d-xl-flex align-items-center justify-content-center bg-body" style="width: 35px; height: 35px; min-width: 35px;">
                            ...
                            <div class="py-2 px-2 px-xl-5 border-xl-top d-none d-xl-flex justify-content-between align-items-center bg-body">
